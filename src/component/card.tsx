export default function Card() {
  return (
    <div className="cursor-pointer bg-neutral-800 border border-neutral-700 w-96 p-4 group transition-all duration-300 rounded-2xl hover:-translate-y-2 overflow-hidden">
      <div>
        <img className="h-48 object-cover rounded-xl" src="/tes.jpg" alt="" />
      </div>
      <div className="mt-4">
        <p className="text-xl font-bold mb-2 text-center">Project Name</p>
        <p>
